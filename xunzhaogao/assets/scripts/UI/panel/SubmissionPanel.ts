 ...
 * @LastEditTime: 2020-04-27 11:42:16
 * @Description: 游戏脚本
 * @FilePath: \xunzhaogao\assets\scripts\UI\panel\SubmissionPanel.ts
 */
...
export default class SubmissionPanel extends BaseUI {
    ...
    //添加答案信息
    AddNet(gameDataJson) {
        let data = { title_id: NetWork.titleId, courseware_content: gameDataJson, is_result: 1, is_lavel: 1, lavel_num: 3 };
    ...
    ModifyNet(gameDataJson) {
        let jsonData = { courseware_id: NetWork.coursewareId, courseware_content: gameDataJson, is_result: 1, is_lavel: 1, lavel_num: 3 };
