...
isAndroid && window.setupWebViewJavascriptBridge(function(e) {
    e.init(function(e, t) {
        console.log(e),
        t("JS 返回给原生的消息内容")
    }),
...
(typeof window == "undefined" ? global : window).gameMsg = {
    ...
    send_to_client: function(e) {
        var t = +new Date;
        this.last_type == e.type && this.last && t < this.last + this.threshhold || (this.last = t,
        this.last_type = e.type,
        window.self == window.parent ? GameMsg2App(e) : window.parent.postMessage({
            type: "gameMsg",
            msg: e
        }, "*"))
    },
