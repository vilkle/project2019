 ...
 * @LastEditTime: 2020-03-09 15:24:04
 * @Description: 游戏脚本
 * @FilePath: \shenqipaopao\assets\scripts\Data\ConstValue.ts
 */
...
export class ConstValue {
    ...
    public static readonly CoursewareKey = "shenqipaopao_169_machao";//每个课件唯一的key 24位随机字符串 可用随机密码生成器来生成。
}
