...
var SubmissionPanel = /** @class */ (function (_super) {
    ...
    SubmissionPanel.prototype.DetectionNet = function () {
        var data = JSON.stringify({ types: DaAnData_1.DaAnData.getInstance().types, checkpointsNum: DaAnData_1.DaAnData.getInstance().checkpointsNum, picArr: DaAnData_1.DaAnData.getInstance().picArr, range: DaAnData_1.DaAnData.getInstance().range });
