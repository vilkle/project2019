 ...
 * @LastEditTime: 2020-03-26 16:45:58
 * @Description: 游戏脚本
 * @FilePath: \wucaibinfenbang\assets\scripts\Data\ConstValue.ts
 */
...
export class ConstValue {
    ...
    public static readonly CoursewareKey = "wucaibinfenbang_169_machao";//每个课件唯一的key 24位随机字符串 可用随机密码生成器来生成。
}
