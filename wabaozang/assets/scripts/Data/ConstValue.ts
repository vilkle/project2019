 ...
 * @LastEditTime: 2020-04-22 22:00:07
 * @Description: 游戏脚本
 * @FilePath: \wabaozang\assets\scripts\Data\ConstValue.ts
 */
...
export class ConstValue {
    ...
    public static readonly CoursewareKey = "wabaozang_169_machao";//每个课件唯一的key 24位随机字符串 可用随机密码生成器来生成。
}
